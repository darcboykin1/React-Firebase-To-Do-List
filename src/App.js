...
class App extends Component {
  ...
  //WHAT I DID(WRONG)
  // createTodo(todoText) {
  //   // todoText = document.querySelectorAll('input').value
  //   let url = 'https://todo-f8469.firebaseio.com/.json'
  //   axios.post(url, {
  //     title:todoText,
  //     createdAt:new Date
  //   }).then((res) => {
  //     console.log(res);
  //     this.setState({ todos:res.config.data });
  //   })
  // }
  //SOLUTION BELOW:
  createTodo(todoText) {
    ...
    axios({
      url: '/todos.json',
      baseURL: 'https://todo-f8469.firebaseio.com/',
      method: "POST",
      data: newTodo
    }).then((response) => {
